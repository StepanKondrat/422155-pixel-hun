import {createScreen, render, clearInputs} from '../logic/utils.js';
import getBack from '../logic/get-back-to-start-btn.js';
import screenGameTwo from './game-2.js';
const screenGameOne = createScreen(`<header class="header">
...
radiobuttons.forEach((item, i, array) => {
  item.addEventListener(`change`, () => {
    ...
    if (gameOne && gameTwo) {
      ...
      render(screenGameTwo);
    }
  });
});

getBack(`.back`, screenGameOne);
